  ...
  return (
    <div className={about.aboutContainer}>
      ...
      <div className={about.aboutBody}>
        <h1 className={about.title}>Examinations Hub</h1>
        <h2>
          Examination-Hub shortens and boosts the processes between the instructor and the student, contains  and illustrates the relation between the instructor and the students. So that the instructor creates and publishes the exams and then they are available to his students.
        </h2>
        <section>
          <span className={about.sectionHead}>
        ...
        <section>
          ...
          <span className={about.sectionBody}>
            after you click signup, you will be directed to page where the user choose which account to create (instructor or student) after filling out all the required fields you will be directed to create your profile options and after submitting you will be directed to your dashboard.
          </span>
        </section>
        <section>
          <span className={about.sectionHead}>
